...
import Furniture from '../components/RentUp/Furniture'
import Flora from '../components/RentUp/Flora'
...
window.scrollTo(0,0)
  ...
  return (
    <div>
                ...
                <img src='/flora1.png' alt="" className='img-popup' />
            </div>
                    <Nav
                        name='Haydar'
                        menu={[                            
                ...
                <Flora value={()=>setPopup(pop === 'block' ? 'none' : 'block' )}/>
                <BestProject/>
                <Footer/>
